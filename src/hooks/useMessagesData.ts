...
const demoMessages: MessageLocal[] = [
  { id: 1, sender: "Prof. Carlos Mendoza", senderRole: "Profesor de Matemáticas", avatar: "CM", subject: "Reunión de coordinación - 5° Primaria", preview: "Estimados padres, les escribo para coordinar la reunión bimestral...", content: "Estimados padres de familia,\n\nLes escribo para coordinar la reunión bimestral del 5° Primaria A. La reunión se llevará a cabo el próximo viernes a las 3:00 PM en el auditorio principal.\n\nTemas a tratar:\n- Avances académicos del bimestre\n- Próximos eventos escolares\n- Tareas pendientes\n\nAgradezco confirmar su asistencia.\n\nSaludos cordiales,\nProf. Carlos Mendoza", date: demoDate(0), time: "10:30 AM", unread: true, category: "inbox", recipients: ["Padres de 5° Primaria A"] },
  { id: 2, sender: "Dirección Académica", senderRole: "Administración", avatar: "DA", subject: "Suspensión de clases - Capacitación docente", preview: "Estimada comunidad educativa, informamos que habrá suspensión de clases...", content: "Estimada comunidad educativa,\n\nInformamos que el próximo lunes no habrá clases debido a actividades de capacitación docente.\n\nLas clases se reanudarán normalmente al día siguiente.\n\nGracias por su comprensión.\n\nAtentamente,\nDirección Académica", date: demoDate(1), time: "4:15 PM", unread: true, category: "announcements", recipients: ["Toda la comunidad"], attachments: [{ name: "comunicado-oficial.pdf", type: "pdf", size: "245 KB" }] },
  { id: 3, sender: "Ana Rodríguez (Mamá de Juan)", senderRole: "Padre de familia", avatar: "AR", subject: "Consulta sobre tareas de matemáticas", preview: "Buenos días profesor, tengo una consulta sobre las tareas...", content: "Buenos días profesor,\n\nTengo una consulta sobre las tareas de matemáticas de esta semana. Mi hijo Juan no entiende muy bien el tema de fracciones.\n\n¿Podría darle una tutoría adicional?\n\nGracias,\nAna Rodríguez", date: demoDate(3), time: "2:45 PM", unread: false, category: "inbox", recipients: ["Prof. Carlos Mendoza"] },
  { id: 4, sender: "Prof. María López", senderRole: "Profesora de Comunicación", avatar: "ML", subject: "Material de lectura - 3° Primaria", preview: "Adjunto el material de lectura para la próxima semana...", content: "Estimados padres,\n\nAdjunto el material de lectura que los estudiantes deberán leer durante la próxima semana.\n\nPor favor, ayuden a sus hijos a completar la ficha de comprensión lectora.\n\nSaludos,\nProf. María López", date: demoDate(5), time: "11:20 AM", unread: false, category: "course", recipients: ["Padres de 3° Primaria A"], attachments: [{ name: "lectura-semana-10.pdf", type: "pdf", size: "1.2 MB" }, { name: "ficha-comprension.pdf", type: "pdf", size: "456 KB" }] },
  { id: 5, sender: "Secretaría Académica", senderRole: "Administración", avatar: "SA", subject: "Recordatorio: Pago de pensión del mes", preview: "Estimados padres, les recordamos que el pago de la pensión...", content: "Estimados padres de familia,\n\nLes recordamos que el pago de la pensión del presente mes vence el día 15.\n\nPueden realizar el pago a través de:\n- Transferencia bancaria\n- Pago en secretaría\n- Pago en línea (próximamente)\n\nGracias por su puntualidad.\n\nSecretaría Académica", date: demoDate(7), time: "9:00 AM", unread: false, category: "announcements", recipients: ["Todos los padres"] },
];

export function useMessagesData() {
  const { user } = useAuth();
  const [conversations, setConversations] = useState<MessageLocal[]>(() =>
    isSupabaseEnabled() ? [] : demoMessages
  );
